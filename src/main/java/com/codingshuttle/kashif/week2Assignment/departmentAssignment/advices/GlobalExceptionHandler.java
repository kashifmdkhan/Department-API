package com.codingshuttle.kashif.week2Assignment.departmentAssignment.advices;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<?>> handleResourceNotFound(DepartmentNotFound exception){
